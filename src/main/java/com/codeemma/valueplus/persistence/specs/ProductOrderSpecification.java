package com.codeemma.valueplus.persistence.specs;
...
public class ProductOrderSpecification implements Specification<ProductOrder> {

    private final List<SearchCriteria> list;

    public ProductOrderSpecification() {
    ...
    @Override
    public Predicate toPredicate(Root<ProductOrder> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
